...
__IMOSH_FLAGS=([0]="IMOSH:help" [1]="IMOSH:helpfull" [2]="IMOSH:alsologtostderr" [3]="IMOSH:logtostderr" [4]="IMOSH:log_dir" [5]="IMOSH:stacktrace_threshold" [6]="IMOSH:help_format")
